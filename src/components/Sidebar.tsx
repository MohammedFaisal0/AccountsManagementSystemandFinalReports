...
export default function Sidebar() {
  ...
  return (
    <aside className="w-72 min-h-screen bg-gradient-to-b from-blue-700 via-blue-800 to-blue-900 rounded-xl shadow-2xl p-6 flex flex-col items-stretch transition-all duration-300 print:hidden">
      {/* User Info */}
      <div className="flex flex-col items-center justify-center mt-6 mb-12">
        <div className="text-center">
